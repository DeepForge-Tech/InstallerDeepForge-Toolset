...
sudo g++ -o ./build/$os/InstallerDeepForge-Toolset ./src/InstallerDeepForge_Toolset.cpp -DCURL_STATICLIB -I ../../include -I ./src/include -L ../../lib/ -L ./src/lib -lZipper  -lcurl -lsqlite3 -std=c++2a
echo "==> Build of project finished"
cd build
cd $os
sudo ./installerDeepForge-Toolset
#echo "=================================="
exit 0
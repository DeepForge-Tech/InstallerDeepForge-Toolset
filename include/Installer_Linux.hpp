        ...
        void Download(string url, string dir,bool Progress)
        {
            try {
                ...
                if (response != CURLE_OK)
                {
                    switch (response)
                    {
                        case LOG_ERROR_CURLE_COULDNT_CONNECT:
                            throw domain_error(translate["LOG_ERROR_CURLE_COULDNT_CONNECT"].asCString());
                        case LOG_ERROR_CURLE_COULDNT_RESOLVE_HOST:
                            throw domain_error(translate["LOG_ERROR_CURLE_COULDNT_RESOLVE_HOST"].asCString());
                        case LOG_ERROR_CURLE_COULDNT_RESOLVE_PROXY:
                            throw domain_error(translate["LOG_ERROR_CURLE_COULDNT_RESOLVE_PROXY"].asCString());
                        case LOG_ERROR_CURLE_UNSUPPORTED_PROTOCOL:
                            throw domain_error(translate["LOG_ERROR_CURLE_UNSUPPORTED_PROTOCOL"].asCString());
                        case LOG_ERROR_CURLE_SSL_CONNECT_ERROR:
                            throw domain_error(translate["LOG_ERROR_CURLE_SSL_CONNECT_ERROR"].asCString());
                    }
                }
